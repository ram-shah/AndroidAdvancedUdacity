...
public final class QueryUtils {
     ...
     * parsing a JSON response.
     */
    public static ArrayList<Trailer> extractTrailers(String jsonResponse) {
        ...
        try {
            ...
            // Parse the response given by the jsonResponse string and
            // build up a list of Trailer objects with the corresponding data.
            JSONObject root = new JSONObject(jsonResponse);
            JSONArray results = root.getJSONArray("results");
    ...
    public static ArrayList<Review> extractReviews(String jsonResponse) {
        ...
        try {
            ...
            // Parse the response given by the jsonResponse string and
            // build up a list of Review objects with the corresponding data.
            JSONObject root = new JSONObject(jsonResponse);
            JSONArray results = root.getJSONArray("results");
     ...
     */
    public static URL createUrl(String param) {
        URL url = null;
        try {
     ...
     * Returns new URL object
     */
    public static URL createUrl(String param1, String param2) {
        URL url = null;
        try {
            Uri.Builder builder = new Uri.Builder();
            builder.scheme("https")
