...
public class Movie {
    ...
    public Movie(Bitmap moviePosterBitmap, long movieId, boolean isFavorite) {
        this.mMoviePosterBitmap = moviePosterBitmap;
        this.mMovieId = movieId;
    ...
    public Movie(Bitmap moviePosterBitmap, long movieId, String title, String plot,
                 String userRating, String releaseDate, boolean isFavorite) {
        this.mMoviePosterBitmap = moviePosterBitmap;
        this.mMovieId = movieId;
        this.mTitle = title;
        this.mPlot = plot;
