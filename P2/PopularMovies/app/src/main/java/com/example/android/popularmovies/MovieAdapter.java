...
public class MovieAdapter extends ArrayAdapter<Movie> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (gridViewItem == null) {
            gridViewItem = LayoutInflater.from(mContext).inflate(R.layout.movie_list_item,
                    parent, false);
        ...
        if (currentMovie.isFavorite() == true) {
            holder.posterImageView.setImageBitmap(currentMovie.getMoviePosterBitmap());
        } else {
